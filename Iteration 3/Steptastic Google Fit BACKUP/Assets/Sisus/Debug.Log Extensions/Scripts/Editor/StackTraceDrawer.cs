		...
		private bool TryFindUnityObjectInstances(StackTraceData stackTraceLine, out Object[] foundInstances)
        {
			...
			else if(typeof(Component).IsAssignableFrom(classType))
			{
				foundInstances = 
					...
					Object.FindObjectsByType(classType, FindObjectsSortMode.None)
					#elif UNITY_2020_1_OR_NEWER
					Object.FindObjectsOfType(classType, true)
					#else
					Object.FindObjectsOfType(classType)
					#endif
					.Select(i => (i as Component).gameObject).ToArray();
			}
			else
            {
				foundInstances = new Object[0];
