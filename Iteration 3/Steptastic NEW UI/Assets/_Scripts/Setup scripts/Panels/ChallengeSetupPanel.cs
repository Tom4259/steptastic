...
public class ChallengeSetupPanel : MonoBehaviour
{
    ...
    [Space]
    public ModalWindowManager sameLocationMessage;

    [Space]
    public TMP_Text challengeDescriptionText;
    [TextArea]
    public string descriptionText = "You will be virtually walking {{distance}}! WOW";
