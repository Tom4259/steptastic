...
public class HealthKitTest : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (Application.platform != RuntimePlatform.IPhonePlayer)
        {
            ...
            //instructionLabel.color = Color.red;
            //instructionLabel.text = "To use this plugin, you MUST run on an iOS device or in the iOS Simulator. \nIt WILL NOT WORK in the editor.";
        ...
        {
            healthStore.Authorize(types, delegate (bool success)
            {
    ...
    public void ReadData()
    {
        ...
        if (!reading)
        {
            ...
            DateTimeOffset start = now.AddHours(-now.Hour).AddMinutes(-now.Minute);
