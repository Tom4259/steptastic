...
public class GoalsWindow : MonoBehaviour
{
	...
	private async void LoadWeekProgressBars()
	{
		...
		List<APIManager.HealthKit.QuantityData> data = await APIManager.HealthKit.GetStepsList(UsefulFunctions.StartOfWeek(), DateTime.Now);
