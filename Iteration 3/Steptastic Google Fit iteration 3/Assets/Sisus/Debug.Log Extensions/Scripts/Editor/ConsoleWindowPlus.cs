...
namespace Sisus.Debugging.Console
{
	internal sealed class ConsoleWindowPlus : ConsoleWindowPlusBase, IHasCustomMenu, ISerializationCallbackReceiver
	{
		...
		protected override bool WasCompilingLastFrame => false;
		protected override bool InitialMessagesFetched => true;
		protected override bool FirstMessageReceived { get => true; set { } }
