...
namespace Sisus.Debugging.Console
{
	...
	public class Log
	{
		...
		public bool isCompileWarningOrError;
		...
		public Log(string text, string stackTrace, LogType type, Object context, bool isCompileWarningOrError)
		{
			if(text == null)
			{
				text = "";
			...
			this.isCompileWarningOrError = isCompileWarningOrError;
		...
		public Log(string textUnformatted, string textFormatted, string stackTrace, LogType type, Object context, bool isCompileWarningOrError)
		{
