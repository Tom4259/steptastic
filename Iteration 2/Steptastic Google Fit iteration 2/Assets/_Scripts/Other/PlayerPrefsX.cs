...
public class PlayerPrefsX
{
    ...
    public static string GetString(String name, String defaultText)
    {
        return PlayerPrefs.GetString(name, defaultText);
    }
    ...
    public static int GetInt(String name, int defualtInt)
    {
        return PlayerPrefs.GetInt(name, defualtInt);
    }
    ...
    public static float GetFloat(String name, float defualtFloat)
    {
        return PlayerPrefs.GetFloat(name, defualtFloat);
    }
    ...
    {
        //Debug.Log(PlayerPrefsKeyStorage.debugChannels.playerPrefs + " Setting " + key + " to " + value + " in " + System.Reflection.MethodBase.GetCurrentMethod().Name);
